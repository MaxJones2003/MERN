...
const ServerPage = () => {
  ...
  // ── Channels from dedicated endpoints (not server.textChannels which are just IDs) ──
  const {
    textChannels,
    voiceChannels,
  ...
  // ── Chat thread for the active channel ──
  const {
    messages,
  ...
  const handleChannelCreated = async () => {
    ...
    // Refresh the channel list from the API
    refreshChannels();
  };

  const handleChannelClick = (id: string) => {
    navigate(`/chat/server/${serverId}/${id}`);
  };
  ...
  const handleDeleteChannel = async () => {
    ...
    try {
      ...
      const response = await authFetch(
        `api/servers/${serverId}/textChannels/${channelToDelete.id}`,
        { method: 'DELETE' }
      );
      if (!response.ok) {
      ...
      // If the deleted channel is currently active, go back to server overview
  ...
  return (
    <div className="server-screen">
                ...
                <div key={channel._id} className="channel-item-wrapper">
                  ...
                  {isOwner && (
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        setChannelToDelete({ id: channel._id, name: channel.channelName });
                      }}
      ...
      <div className="server-chat-area">
        <div className="server-chat-header">
          <div className="header-left">
            ...
            <span className="channel-name">
              {activeChannel ? activeChannel.channelName : 'Select a channel'}
            </span>
            {activeChannel && (
              <div className="channel-description">
                {activeChannel.topic ? activeChannel.topic : `Welcome to #${activeChannel.channelName}!`}
              </div>
            )}
          </div>
        </div>
        ...
        {channelId ? (
          <MessageComposer disabled={false} onSend={sendMessage} />
        ) : (
        ...
        <div className="delete-modal-overlay" onClick={() => !isDeleting && setShowDeleteModal(false)}>
          <div className="delete-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="delete-modal-footer">
              ...
              <button className="btn-confirm-delete" onClick={handleDeleteServer} disabled={isDeleting}>
        ...
        <div className="delete-modal-overlay" onClick={() => !isDeletingChannel && setChannelToDelete(null)}>
          <div className="delete-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="delete-modal-footer">
              ...
              <button className="btn-confirm-delete" onClick={handleDeleteChannel} disabled={isDeletingChannel}>
